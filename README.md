...
Uma aplicação web moderna para avaliação e acompanhamento da performance de equipes de desenvolvimento, criada especificamente para a **Tivix Technologies**.

## 🚀 Visão Geral

O **Tivix Performance Tracker** é uma ferramenta completa que permite aos gerentes de projeto avaliar a performance mensal de suas equipes de desenvolvedores de forma estruturada, intuitiva e visualmente atraente. A aplicação serve tanto como ferramenta interna de gestão quanto como showcase da qualidade técnica da Tivix Technologies.
...
Desenvolvido para a **Tivix Technologies** como ferramenta interna de gestão de performance e showcase técnico.

## 📄 Licença

Propriedade da Tivix Technologies. Todos os direitos reservados.

---

**Tivix Technologies** - Transformando ideias em soluções digitais excepcionais.
